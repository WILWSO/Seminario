/*
  # Traducir estados de matrícula al español

  1. Cambios
    - Actualizar valores existentes de inglés a español primero
    - Luego modificar la constraint para aceptar solo valores en español
    - Actualizar comentarios para usar terminología en español

  2. Orden correcto de operaciones
    - Primero actualizar datos existentes
    - Después modificar restricciones
*/
